          ...
          <div class="product-single__media" data-media-type="vertical-thumbnail">
              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide product-single__image-item">
                        <img loading="lazy" class="h-auto" src="{{asset("storage/$product->image")}}" width="674" height="674" alt="{{$product->image}}" />
                    ...
                    @foreach (json_decode($product->images, true) as $image)
                        <div class="swiper-slide product-single__image-item">
                            <img loading="lazy" class="h-auto" src="{{asset("storage/$image")}}" width="674" height="674" alt="" />
                            <a data-fancybox="gallery" href="{{asset("storage/$image")}}" data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <use href="#icon_zoom" />
                                </svg>
                            </a>
            ...
            <div class="product-single__thumbnail">
              <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide product-single__image-item">
                        <img loading="lazy" class="h-auto" src="{{asset("storage/$product->image")}}" width="104" height="104" alt="" />
                    </div>
                    @foreach (json_decode($product->images, true) as $image)
                        <div class="swiper-slide product-single__image-item">
                            <img loading="lazy" class="h-auto" src="{{asset("storage/$image")}}" width="104" height="104" alt="" />
                        </div>
                    @endforeach
                </div>
              </div>
          ...
          <div class="product-single__price">
            <span class="current-price">
                @if($product->sale_price)
                    <s class="text-secondary">${{$product->regular_price}}</s> ${{$product->sale_price}}
                @else
          ...
          <div class="product-single__addtolinks">
            @if(Cart::instance('wishlist')->content()->where('id', $product->id)->count() > 0)
              <form action="{{route('wishlist.item.remove', Cart::instance('wishlist')->content()->where('id', $product->id)->first()->rowId)}}" method="POST" id="remove-item">
                @csrf
                @method('DELETE')
                <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist filled-heart" onclick="document.getElementById('remove-item').submit();">
            ...
            @foreach ($related_products as $rProduct)
                <div class="swiper-slide product-card">
                    ...
                    <div class="pc__info position-relative">
                        ...
                        <h6 class="pc__title">
                            <a href="{{route('shop.product.details', $rProduct->slug)}}">{{$rProduct->name}}t</a>
                        </h6>
                        <div class="product-card__price d-flex">
                            <span class="money price">
                                @if($product->sale_price)
                                    <s class="text-secondary">${{$rProduct->regular_price}}</s> ${{$rProduct->sale_price}}
                                @else
